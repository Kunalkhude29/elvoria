        ...
        <section className="container py-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {HIGHLIGHTS.map((item, idx) => (
                    <div key={idx} className="relative group overflow-hidden bg-beige/30 h-[300px] flex items-center justify-center text-center">
                        ...
                        <div className="relative z-10 px-6">
                            ...
                            <h2 className="text-2xl font-serif text-charcoal mb-6">{item.subtitle}</h2>
