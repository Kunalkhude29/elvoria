...
export default function WishlistPage() {
    ...
    const getRedirectUrl = () => {
        ...
        if (activeNavTab === '/women') return '/'; // Handle legacy bad state
        return activeNavTab;
    };
        ...
        <div className="min-h-screen bg-ivory flex flex-col">
            ...
            {wishlist.length === 0 ? (
                <main className="flex-1 flex flex-col items-center justify-center px-6 pt-20">
                    <h1 className="text-4xl md:text-5xl font-serif text-charcoal mb-4 text-center">Your Wishlist is Waiting.</h1>
                    <p className="text-charcoal/60 text-center max-w-[500px] mb-10">
                        Save your favorite pieces and revisit them anytime.
                    </p>
                    <Link
                        href={redirectUrl}
                        className="px-8 py-3 lg:py-4 bg-transparent border border-charcoal text-charcoal rounded-md text-sm font-medium tracking-widest uppercase hover:bg-charcoal hover:text-white transition-all duration-300"
                    >
                        CONTINUE SHOPPING
                    </Link>
                </main>
