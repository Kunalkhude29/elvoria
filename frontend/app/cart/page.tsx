    ...
    return (
        <div className="min-h-screen bg-background pb-20">
            ...
            <div className="main-container pt-32">
                <h1 className="text-3xl lg:text-4xl font-outfit text-charcoal mb-12">Your Shopping Bag</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                                ...
                                <div key={item.id} className="flex gap-6 border-b border-gray-100 pb-6">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start mb-2">
                                            <Link href={`/product/${item.id}`} className="font-outfit text-lg text-charcoal hover:text-gold transition-colors">
                                                {item.name}
                                            </Link>
                                        ...
                                        <p className="text-sm font-outfit font-semibold text-charcoal/60 mb-4">₹{Number(item.price).toFixed(2)}</p>
                                        ...
                                        <div className="flex items-center space-x-4">
                                            <div className="flex items-center border border-gray-200">
                                                ...
                                                <span className="w-8 text-center text-sm font-outfit font-semibold font-medium">{item.quantity}</span>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white p-8 border border-gray-100 sticky top-32">
                                <h2 className="font-outfit text-xl mb-6">Order Summary</h2>
                                <div className="space-y-4 mb-6 text-sm font-outfit text-charcoal/80">
                                ...
                                <div className="border-t border-gray-100 pt-4 mb-8 flex justify-between font-outfit font-semibold font-bold text-lg">
                                    <span>Total</span>
                                    <span>₹{cartTotal.toFixed(2)}</span>
                                </div>
                                <button 
                                ...
                                >
                                    <span>{authLoading ? 'Loading...' : 'Checkout'}</span>
