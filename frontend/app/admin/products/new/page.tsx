...
import { Upload, X, Loader2, ArrowLeft, Plus, ChevronDown } from 'lucide-react';
    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            <div className="mb-8 flex items-center gap-4">
                ...
                <h1 className="text-3xl font-outfit font-bold text-charcoal">Add New Product</h1>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <p className="text-[10px] text-gray-400 font-outfit font-semibold uppercase tracking-widest leading-relaxed">
                                    Tip: Use high-quality images with neutral backgrounds. The first image uploaded will be used as the primary display image.
                                </p>
                            </div>
                        </div>
                    </div>
